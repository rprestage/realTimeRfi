...
def main1():
    ...
    g.copy("/home/scratch/rprestag/temp.raw", 0, 1)
    del g

    # read the new file in, and show its sizes
    h = GbtRaw('/home/scratch/rprestag/temp.raw')
...
def main3():
    f1 = GbtRaw('/home/scratch/rprestag/example.raw')
    f1.copy('/home/scratch/rprestag/copy.raw')
    f2 = GbtRaw('/home/scratch/rprestag/copy.raw', update=True)
